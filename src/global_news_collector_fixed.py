...
class GlobalNewsCollector:
    ...
    def _create_global_sample_news(self) -> List[Dict]:
        ...
        return [
            ...
            {
                'title': '이재명 대통령 "반도체 클러스터에 50조원 투자 확정"',
                'link': 'https://www.yonhapnews.com/2026/01/25/president-semiconductor',
                'source': '연합뉴스',
                'date': '2026.01.25',
                'content': '이재명 대통령이 오는 5년간 반도체 클러스터에 50조원 규모의 정부 투자를 확정했다고 발표했다. 이로 인해 삼성전자, SK하이닉스 등 반도체 관련주에 대한 기대감이 높아지고 있다.'
            },
            {
                'title': '대통령실 "부동산 시장 안정화 대책 발표"',
                'link': 'https://www.yonhapnews.com/2026/01/26/real-estate-policy',
                'source': '연합뉴스',
                'date': '2026.01.26',
                'content': '이재명 대통령이 주택 공급 확대와 청년 주거 안정을 위한 부동산 시장 안정화 대책을 발표했다. 건설사와 부동산 관련주에 긍정적 영향이 예상된다.'
            }
        ]
